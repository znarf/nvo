...
function loadMap()
{
    ...
    oMapImg.src = MARIO_STATIC + oMap.texture;
}
...
function startGame() {
    ...
    oCountImg.src = MARIO_STATIC + "/countdown.png";
...
function startMusic() {
    ...
    oMusicEmbed.src = MARIO_STATIC + '/' + strMap + ".mid";
...
var oContainer = document.getElementById("mariokartcontainer")
...
function BGLayer(strImage, iLayerWidth) {
    ...
    oImg1.src = MARIO_STATIC + "/bg_" + strImage + ".png";
    ...
    oImg2.src = MARIO_STATIC + "/bg_" + strImage + ".png";
    ...
    function selectPlayerScreen() {
        ...
        oTitle.src = MARIO_STATIC + "/title.png";
        ...
        for (var i=0;i<aPlayers.length;i++) {
            ...
            oPImg.src = MARIO_STATIC + "/select_" + aPlayers[i] + ".png";
    ...
    function selectMapScreen() {
        ...
        var oTitle = document.createElement("img");
        oTitle.src = MARIO_STATIC + "/mushroomcup.png";
        oTitle.style.position = "absolute";
        ...
        for (var i=0;i<aAvailableMaps.length;i++) {
            var oPImg = document.createElement("img");
            oPImg.src = MARIO_STATIC + "/select_" + aAvailableMaps[i] + ".png";
    ...
    for (var i=0;i<aPlayers.length;i++) {
        var oImg = new Image();
        oImg.src = MARIO_STATIC + "/sprite_" + aPlayers[i] + "_smooth.png";
    }
