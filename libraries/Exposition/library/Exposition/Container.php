 ...
 * Widgets Container.
 *
 * This class Exposition_maps some widgets descriptors retrieved from the
...
class Exposition_Container
{
    ...
    /**
     * Returns the widget CSS class Exposition_name value.
     *
     * @param Netvibes_Widget $widgetDescriptor
     * @return string
     */
